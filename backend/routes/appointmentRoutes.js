...
import {createAppointment, getAppointmentsByDate, getAppointmentsById,updateAppointment, deleteAppointment, searchAppointments} from '../controlers/appointmentController.js'
...
router.route('/search').get(authMiddleware, searchAppointments);
