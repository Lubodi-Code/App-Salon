...
<template>
  <div class="space-y-8">
    <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
      <p class="text-white">
        Total de citas: {{ userStore.userAppointments.length }}
      </p>
      <input
        v-model="search"
        type="text"
    ...
    <!-- Aquí el div unificado sin conflictos -->
    <div class="bg-gray-800 rounded-lg p-4 sm:p-6 overflow-x-auto">
      <p v-if="isLoading" class="text-white text-center">
        Cargando citas...
      </p>
      <div v-else>
        <p
